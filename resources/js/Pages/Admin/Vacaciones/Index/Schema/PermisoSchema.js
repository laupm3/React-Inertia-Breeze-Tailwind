import { z } from 'zod';
import { formatDate } from '@/Pages/Admin/SolicitudPermisos/Index/Utils/dateUtils'; 

// Constante para el tipo de permiso de vacaciones (debe coincidir con el backend)
// Esta constante está definida en VacacionesStoreRequest::VACACIONES_PERMISO_ID
export const TIPO_PERMISO_VACACIONES_ID = 1;

export const defaultPermisoValues = {
    empleado_id: null, // Campo requerido para admin
    permiso_id: TIPO_PERMISO_VACACIONES_ID, // Automáticamente establecer el tipo de permiso de vacaciones
...
export const permisoFormSchema = z.object({
    empleado_id: z.coerce.number({
        invalid_type_error: "Debe seleccionar un empleado.",
        required_error: "Debe seleccionar un empleado."
    }).int("ID de empleado debe ser un entero.").positive("Debe seleccionar un empleado.").nullable().refine(val => val !== null, "Debe seleccionar un empleado."),
    permiso_id: z.coerce.number({
        invalid_type_error: "Tipo de permiso inválido.",
        required_error: "Tipo de permiso requerido."
    }).int("ID de permiso debe ser un entero.").positive("Tipo de permiso inválido.").default(TIPO_PERMISO_VACACIONES_ID),
