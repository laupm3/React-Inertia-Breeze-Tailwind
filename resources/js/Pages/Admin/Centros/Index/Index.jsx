...
import CreateUpdateViewComponent from '@/Components/App/Centro/CreateUpdateDialog/CreateUpdateDialog';
import SheetTableViewComponent from '@/Components/App/Centro/SheetTable/SheetTable';
import DeleteViewComponent from '@/Components/App/Centro/DeleteDialog/DeleteDialog';

export default function Index() {
    return (
        <>
            <Head title="Administración de centros" />
