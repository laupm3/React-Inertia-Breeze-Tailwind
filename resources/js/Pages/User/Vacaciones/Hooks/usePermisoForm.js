...
import { defaultPermisoValues, permisoFormSchema } from '@/Pages/User/Vacaciones/Schema/PermisoSchema';
...
/**
 * Custom hook for managing permission form state and logic
 */
export const usePermisoForm = (permisoToEdit = null, isOpen = false) => {
    ...
    }, [shouldForceFullDay, isInitializing]);

    useEffect(() => {
        if (isInitializing || !formData.fecha_inicio || !formData.fecha_fin) return;
