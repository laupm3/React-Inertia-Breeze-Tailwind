...
export const ViewContextProvider = ({
    ...
    const [empleadoContratosVigentesView, setEmpleadoContratosVigentesView] = useState(
    ...
    const handleContratosVigentesView = (empleado) => {
        setEmpleadoContratosVigentesView((prev) => {
            return {
                open: !prev.open,
                empleado: extractModel(empleado)
            }
        });
    }
     ...
     * @returns 
     */
    const extractModel = (model) => model?.empleado?.id ?? model?.id ?? model ?? null;
    ...
    return (
        <ViewContext.Provider value={{
            ...
            destroyView,
            setDestroyView,
            empleadoContratosVigentesView,
            setEmpleadoContratosVigentesView,
            handleCreateUpdateView,
            handleSheetView,
            handleDestroyView,
            handleContratosVigentesView,
