...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        ...
        show: model ? route("api.v1.admin.teams.show", { team: model }) : null,
        store: route("api.v1.admin.teams.store"),
        update: model ? route("api.v1.admin.teams.update", { team: model }) : null,
        delete: model ? route("api.v1.admin.teams.destroy", { team: model }) : null,
    }), [model]);
}
