...
export default function DeleteDialog({ open, onOpenChange, model, onDelete }) {
    ...
    return (
        <DecisionModal
            title='¿Estás seguro de que quieres eliminar esta solicitud de vacaciones?'
            content='Esta acción no se puede deshacer. La solicitud de vacaciones se eliminará definitivamente.'
            open={open}
