...
import { defaultValues, useModelSchema } from "@/Components/App/Teams/Schema/ModelSchema";
import { useForm, usePage } from "@inertiajs/react";
import formResource from "@/Components/App/Teams/CreateUpdateDialog/Utils/formResource";
import useApiEndpoints from "@/Components/App/Teams/Hooks/useApiEndpoints";
...
const DialogDataContextProvider = ({
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          form.setData(
            ...
            // Establecer permisos
            setTeamPermissions(response.data.teamPermissions),
          );
        } else {
          setError(true);
        }
  ...
  const contextValue = useMemo(() => ({
    ...
    roles: teamPermissions.availableRoles,
    updateForm,
    handleSubmit,
    setError,
    onOpenChange,
