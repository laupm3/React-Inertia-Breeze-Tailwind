...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        ...
        show: model ? route("api.v1.admin.contratos.show", { contrato: model }) : null,
        store: route("api.v1.admin.contratos.store"),
        update: model ? route("api.v1.admin.contratos.update", { contrato: model }) : null,
        delete: model ? route("api.v1.admin.contratos.destroy", { contrato: model }) : null,
    }), [model]);
}
