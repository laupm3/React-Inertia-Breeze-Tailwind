...
/**
 * Creates a Zod schema for validating solicitud de vacaciones data. It uses the `useTranslation` hook to get translation functions for error messages.
 * 
 * @returns {z.ZodObject} Zod schema for solicitud de vacaciones creation and update
 */
const useModelSchema = () => {
    ...
    return z.object({
        ...
        permiso_id: z.number({ message: 'El tipo de permiso es obligatorio' }).default(1), // 1 = Vacaciones
...
const defaultValues = {
    id: null,
    empleado_id: null,
    permiso_id: 1, // 1 = Vacaciones por defecto
    fecha_inicio: '',
    fecha_fin: '',
    hora_inicio: '',
    hora_fin: '',
