...
use App\Http\Requests\Horario\UserHorariosIndexRequest;
...
{
    private RetrasosService $retrasosService;

    public function __construct(RetrasosService $retrasosService)
    {
        $this->retrasosService = $retrasosService;
    }

    /**
     * Display a listing of the resource.
     */
    public function index(UserHorariosIndexRequest $request)
    {
