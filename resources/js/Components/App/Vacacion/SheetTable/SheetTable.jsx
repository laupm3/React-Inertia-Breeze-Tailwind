        ...
        const fetchData = async () => {
            try {
                ...
                if (response.status === 200) {
                    // Para vacaciones individuales, el backend puede responder con 'solicitud' o 'vacacion'
                    setData(response.data.solicitud || response.data.vacacion || response.data.solicitudPermiso);
                } else {
                    setError(true);
                }
            } catch (error) {
