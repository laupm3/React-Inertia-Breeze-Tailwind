...
export default function DeleteDialog({ open, onOpenChange, model, onDelete }) {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                onOpenChange(false); // Cerrar el modal después de eliminar
            }
        } catch (error) {
    ...
    return (
        <DecisionModal
            ...
            content='Esta acción no se puede deshacer. Todos los datos relacionados con este contrato se eliminarán.'
            open={open}
