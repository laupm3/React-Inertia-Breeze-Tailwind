...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        ...
        show: model ? route("api.v1.admin.turnos.show", { turno: model }) : null,
        store: route("api.v1.admin.turnos.store"),
        update: model ? route("api.v1.admin.turnos.update", { turno: model }) : null,
        delete: model ? route("api.v1.admin.turnos.destroy", { turno: model }) : null,
    }), [model]);
}
