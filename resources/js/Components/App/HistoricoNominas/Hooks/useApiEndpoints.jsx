...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        show: model ? route("api.v1.admin.nominas.show", { nomina: model }) : null,
        store: route("api.v1.admin.nominas.store"),
        update: model ? route("api.v1.admin.nominas.update", { nomina: model }) : null,
        delete: model ? route("api.v1.admin.nominas.destroy", { nomina: model }) : null,
    }), [model]);
}
