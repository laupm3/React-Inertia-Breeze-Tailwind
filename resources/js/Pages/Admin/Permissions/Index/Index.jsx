...
import CreateUpdateViewComponent from '@/Components/App/Permiso/CreateUpdateDialog/CreateUpdateDialog';
import SheetTableViewComponent from '@/Components/App/Permiso/SheetTable/SheetTable';
import DeleteViewComponent from '@/Components/App/Permiso/DeleteDialog/DeleteDialog';

export default function Index() {
    return (
        <>
            <Head title="Permisos (Seguridad) Administración" />
