...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        ...
        show: model ? route("api.v1.admin.departamentos.show", { departamento: model }) : null,
        store: route("api.v1.admin.departamentos.store"),
        update: model ? route("api.v1.admin.departamentos.update", { departamento: model }) : null,
        delete: model ? route("api.v1.admin.departamentos.destroy", { departamento: model }) : null,
    }), [model]);
}
