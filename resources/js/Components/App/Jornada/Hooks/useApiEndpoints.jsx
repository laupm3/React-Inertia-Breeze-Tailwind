...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        dataKey: "jornada",
        show: model ? route("api.v1.admin.jornadas.show", { jornada: model }) : null,
        store: route("api.v1.admin.jornadas.store"),
        update: model ? route("api.v1.admin.jornadas.update", { jornada: model }) : null,
        delete: model ? route("api.v1.admin.jornadas.destroy", { jornada: model }) : null,
    }), [model]);
}
