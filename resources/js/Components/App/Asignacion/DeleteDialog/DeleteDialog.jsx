...
export default function DeleteDialog({ open, onOpenChange, model, onDelete }) {
    ...
    return (
        <DecisionModal
            title='¿Estás seguro de que quieres eliminar esta asignación?'
            content='Esta acción no se puede deshacer. Todos los datos relacionados con esta asignación se eliminarán.'
            open={open}
