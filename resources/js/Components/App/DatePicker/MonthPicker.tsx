...
import { Button, buttonVariants } from "@/Components/App/Buttons/Button"
import {
    Popover,
    PopoverContent,
    PopoverTrigger,
...
export function MonthPicker({ currentMonth, onMonthChange }: MonthPickerProps) {
    ...
    const manageSelection = (newMonth: Date | undefined) => {
        
        console.log('newMonth, currentMonth :>> ', newMonth, currentMonth);
            ...
            <Popover>
                <PopoverTrigger asChild>
                    <Button
                        variant={"ghost"}
                        className={cn(
                            "w-auto justify-center gap-2 text-left font-normal p-2 dark:text-custom-white dark:border-custom-gray-semiDark flex border rounded-lg",
