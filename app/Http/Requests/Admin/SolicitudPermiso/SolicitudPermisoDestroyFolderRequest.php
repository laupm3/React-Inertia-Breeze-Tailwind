...
namespace App\Http\Requests\Admin\SolicitudPermiso;
...
class SolicitudPermisoDestroyFolderRequest extends FormRequest
{
    ...
    {
        // Para admin, solo verificar que el usuario esté autenticado
        // La autorización específica se maneja en el controlador
