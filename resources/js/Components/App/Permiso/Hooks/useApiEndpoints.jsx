...
const useApiEndpoints = (model) => {
    return useMemo(() => ({
        ...
        show: model ? route("api.v1.admin.permissions.show", { permission: model }) : null,
        store: route("api.v1.admin.permissions.store"),
        update: model ? route("api.v1.admin.permissions.update", { permission: model }) : null,
        delete: model ? route("api.v1.admin.permissions.destroy", { permission: model }) : null,
    }), [model]);
}
