                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <div className={`
                            ...
                            ${(STATUS_TIPO_PERMISO_COLOR_MAP as any)[permisoNombre]?.bg || 'bg-gray-500/30'} 
                            ${(STATUS_TIPO_PERMISO_COLOR_MAP as any)[permisoNombre]?.text || 'text-gray-500'} 
                            text-xs rounded-full px-3 py-1
                        `}>
                            <div className={`${(STATUS_TIPO_PERMISO_COLOR_MAP as any)[permisoNombre]?.point || 'bg-gray-500'} w-2 h-2 rounded-full`} />
