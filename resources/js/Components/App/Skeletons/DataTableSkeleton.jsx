 ...
 */
export default function DataTableSkeleton({ rows = 5, columns = 4 }) {
    return (
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg bg-custom-white dark:bg-custom-blackLight shadow-sm">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Skeleton className="h-8 w-24" /> {/* Columnas */}
                            <Skeleton className="h-8 w-28" /> {/* Paginación */}
                            <Skeleton className="h-10 w-40 rounded-md" /> {/* Botón de añadir empresa */}
                        </div>
                    </div>
                    {/* Table Skeleton */}
                    ...
                    <div className="flex items-center justify-between p-2">
                        <Skeleton className="h-6 w-40" /> {/* Texto de cantidad de filas seleccionadas */}
                        <div className="flex items-center gap-2">
                            <Skeleton className="h-8 w-8 rounded-md" /> {/* Botón anterior */}
                            <Skeleton className="h-8 w-16" /> {/* Indicador de página */}
                            <Skeleton className="h-8 w-8 rounded-md" /> {/* Botón siguiente */}
                        </div>
                    </div>
                </div >
            </div>
