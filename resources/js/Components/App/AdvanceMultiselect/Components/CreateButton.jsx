...
function CreateButton({ }) {
    ...
    return (
        <Button
            onClick={handleClick}
            variant="ghost"
            className="text-custom-blackSemi font-normal flex gap-2 w-full items-center justify-start text-start dark:hover:text-custom-gray-light dark:text-custom-gray rounded-md hover:bg-custom-gray-semiLight px-1"
        >
