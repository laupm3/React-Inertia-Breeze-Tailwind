...
import CreateUpdateViewComponent from '@/Components/App/HistoricoNominas/CreateUpdateDialog/CreateUpdateDialog';
// import SheetTableViewComponent from '@/Components/App/HistoricoNominas/SheetTable/SheetTable';
import DeleteViewComponent from '@/Components/App/HistoricoNominas/DeleteDialog/DeleteDialog';

export default function Index() {
    return (
        <>
            <Head title="Histórico de nominas" />
