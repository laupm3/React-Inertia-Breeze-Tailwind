 ...
 * // Resultado: { show: '/api/v1/admin/solicitudes/1', store: '/api/v1/admin/solicitudes', update: '/api/v1/admin/solicitudes/1', delete: '/api/v1/admin/solicitudes/1' }
 * 
 * @example
 * // Para crear una nueva solicitud
 * const endpoints = useApiEndpoints(null);
 * // Resultado: { show: null, store: '/api/v1/admin/solicitudes', update: null, delete: null }
 */
const useApiEndpoints = (model) => {
    return useMemo(() => {
        const baseRoute = 'api.v1.admin.solicitudes';
