...
export default function DialogPortal() {
  ...
  return (
    <DialogContent className="flex flex-col gap-4 justify-between w-fit sm:min-w-[800px] sm:max-w-[1500px] sm:max-h-[900px] bg-custom-white dark:bg-custom-blackLight">
      {isLoading ? (
        <DialogSkeleton />
      ) : (
        <>
