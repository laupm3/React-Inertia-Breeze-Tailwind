            ...
            <DialogContent className="bg-custom-white dark:bg-custom-blackLight text-custom-blue dark:text-custom-white max-w-xl">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-sm text-gray-500 dark:text-gray-400">
                        {isApproval 
                            ? `¿Está seguro que desea aprobar esta solicitud de vacaciones como ${approvalType}?`
                            : `Escriba las observaciones de denegación para esta solicitud de vacaciones como ${approvalType}.`
                        }
                    </DialogDescription>
                </DialogHeader>
