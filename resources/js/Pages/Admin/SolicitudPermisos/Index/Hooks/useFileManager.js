...
/**
 * Hook para manejar archivos adjuntos (versión admin)
 */
export function useFileManager() {
    ...
    const executeFileDelete = async (permisoId, fileHash) => {
        ...
        try {
            // Usar la ruta del admin para eliminar archivos
            const deleteUrl = `/api/v1/admin/solicitudes/${permisoId}/folder/${fileHash}`;
